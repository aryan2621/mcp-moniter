# Self-host demos — developer guide
...
The JS SDK is pulled from `../../sdk/js` as `mcp-monitor-local-sdk`.
...
The Python SDK is pulled from `../../sdk/py` as `mcp-monitor-local-sdk`. Same corrupt-file rule: failed loads disable persist.
